...
describe UsersController do
  ...
  describe "GET 'index'" do
    ...
    describe "for signed-in users" do
      ...
      before(:each) do
        ...
        second = Factory(:user, :name => "Bobmanbolt", :email => "another@example.com")
        third  = Factory(:user, :name => "Bentennew", :email => "another@example.net")
  ...
  describe "GET 'new'" do
    ...
    #it "should have an email field" do
	 # get :new
     # response.should have_selector("email", :content => ":email")
    #end
  ...
  describe "POST 'create'" do
    ...
    describe "failure" do
	  ...
	  post :create, :user => @attr
	  #response.should reset(@user.password)	  
	  end
    end
